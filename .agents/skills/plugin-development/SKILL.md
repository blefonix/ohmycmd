...
license: https://github.com/openmultiplayer/web/blob/master/frontend/docs/tutorials/PluginDevelopmentGuide.md
---
...
- [Getting started](#getting-started)
  ...
  - [Module definition file (\*.def)](#module-definition-file-def)
- [Examining the code](#examining-the-code)
  - [The module definition file](#the-module-definition-file)
    - [What is "**EXPORTS**"](#what-is-exports)
...
- [amx_Exec](#amxexec)
  - [Syntax](#syntax-3)
- [amx_FindPublic](#amxfindpublic)
  - [Syntax](#syntax-4)
- [amx_ftoc](#amxftoc)
  - [Syntax](#syntax-5)
- [amx_GetAddr](#amxgetaddr)
  - [Syntax](#syntax-6)
- [amx_GetString](#amxgetstring)
  - [Syntax](#syntax-7)
- [amx_Push](#amxpush)
  - [Syntax](#syntax-8)
- [amx_PushArray](#amxpusharray)
  - [Syntax](#syntax-9)
- [amx_PushString](#amxpushstring)
  - [Syntax](#syntax-10)
- [amx_Register](#amxregister)
  - [Syntax](#syntax-11)
- [amx_Release](#amxrelease)
  - [Syntax](#syntax-12)
- [amx_SetString](#amxsetstring)
  - [Syntax](#syntax-13)
- [amx_StrLen](#amxstrlen)
  - [Syntax](#syntax-14)
- [amx_StrParam](#amxstrparam)
  - [Syntax](#syntax-15)
- [Amx function examples](#amx-function-examples)
  - [Registering natives](#registering-natives)
  - [Alternative way to get a string](#alternative-way-to-get-a-string)
  - [How to set a string](#how-to-set-a-string)
  - [Casting and returning floats](#casting-and-returning-floats)
  - [Passing parameters by reference](#passing-parameters-by-reference)
  - [Getting and modding array values](#getting-and-modding-array-values)
  - [Call a callback](#call-a-callback)
- [Calling natives and hooking callbacks](#calling-natives-and-hooking-callbacks)
  - [Invoke](#invoke)
    - [Getting started](#getting-started-2)
    - [Adding SA-MP natives](#adding-sa-mp-natives)
    - [Calling natives](#calling-natives)
  - [Hooking callbacks](#hooking-callbacks)
- [Closing](#closing)
  - [Plugin include](#plugin-include)
  - [Plugin source code](#plugin-source-code)
